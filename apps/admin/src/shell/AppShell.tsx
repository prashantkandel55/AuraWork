  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        {/* Bottom user area */}
        {!sidebarCollapsed && (
          <div className="mx-3 mb-4 mt-2 rounded-xl bg-slate-50 border border-slate-200 p-3 flex items-center gap-3 relative transition-colors group">
            <Link to="/profile" className="flex items-center gap-3 flex-1 min-w-0 hover:bg-slate-100 p-1 -m-1 rounded-lg transition-colors">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-xs font-bold text-white flex-shrink-0 group-hover:scale-105 transition-transform">
                AD
              </div>
            ...
            <Link to="/login" className="ml-auto text-slate-400 hover:text-slate-600 flex-shrink-0 p-1" title="Logout">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 flex-shrink-0 border-b border-slate-200 bg-white flex items-center justify-between px-6 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Avatar */}
            <Link to="/profile" className="h-9 w-9 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-xs font-bold text-white shadow-sm cursor-pointer hover:shadow-md transition-all">
              AD
            </Link>
          </div>
        </header>
